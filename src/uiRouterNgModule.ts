...
/** @hidden */ export const UIROUTER_ROOT_MODULE = 'UIRouter Root Module';
/** @hidden */ export const UIROUTER_MODULE_TOKEN = 'UIRouter Module';
/** @hidden */ export const UIROUTER_STATES = 'UIRouter States';
